...
- Баркод — считай каждую цифру по одной, не пропуская и не добавляя. Стандартный баркод EAN-13 содержит ровно 13 цифр. Если получилось 14 — ты ошибся, пересчитай.
